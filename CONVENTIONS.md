...
**Additional endpoints** available (not all implemented in library yet):
...
- `/api/s/{site}/rest/firewall-policies` - Firewall policies
- `/api/s/{site}/stat/ups-devices` - UPS devices
- `/api/s/{site}/stat/sysinfo` - System info
- And many more - see `.cursor/rules/unifi-api-reference.mdc` for full list
